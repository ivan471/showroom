			...
			<article class="gallery-wrap">
  			...
  			<div>
					<a href="" data-fancybox="">
						<img class="img-responsive" src="<?= $mobil['gambar1'];  ?>"></a></div>
					</div> <!-- slider-product.// -->
					<div class="img-small-wrap">
  					<div class="item-gallery"> <img src="<?= $mobil['gambar2'];  ?>"></div>
  					<div class="item-gallery"> <img src="<?= $mobil['gambar3'];  ?>"></div>
  					<div class="item-gallery"> <img src="<?= $mobil['gambar4'];  ?>"></div>
					</div> <!-- slider-nav.// -->
